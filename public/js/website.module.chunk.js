...
/***/ "./node_modules/lt-treeview/esm5/lt-treeview.js":
...
var LtTreeviewComponent = (function () {
    ...
    LtTreeviewComponent.prototype.addRootNode = function (item) {
        var _this = this;
        var node = convertAddedToNode(item);
        var emitNode = ({
            node: node
        });
        if (this.callBackOnUpdate != undefined) {
            if (this.component == undefined) {
                ...
                if (this.callBackOnUpdate && typeof this.callBackOnUpdate == 'function') {
                    var method = this.callBackOnUpdate.bind(this.component);
                    ...
                    if (this.callBackOnDelete != undefined) {
                        if (this.component == undefined) {
                            ...
                            if (this.callBackOnDelete && typeof this.callBackOnDelete == 'function') {
                                var method = this.callBackOnDelete.bind(this.component);
                                method(emitNode);
                            }
                            else {
    ...
    LtTreeviewComponent.prototype.addNode = function (item) {
        ...
        this.data.forEach(function (node) {
            if (node === _this.currentNode) {
                var convertedNode = convertAddedToNode(item);
                if (_this.callBackOnUpdate == undefined) {
                    ...
                    if (_this.component == undefined) {
                        ...
                        if (typeof _this.callBackOnUpdate == 'function') {
                            var method = _this.callBackOnUpdate.bind(_this.component);
                            method(emitNode).then(function (res) {
                                node.children.push(res);
                                node.expand = true;
                            });
...
LtTreeviewComponent.decorators = [
    { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"], args: [{
                ...
                styles: [".container{margin-top:30px;margin-left:auto;margin-right:auto;min-height:100px}.box-lt-treeview{position:relative}.box-lt-treeview button{padding:15px;border-radius:unset;background-color:#4ba6c9;border:unset;color:#fff;cursor:pointer}.box-lt-treeview .list-root{background-color:#9c9c9c;border:1px solid;width:250px;z-index:1000;position:absolute;top:0;left:89px;color:#fff}.box-lt-treeview .list-root ul{list-style:none;padding:unset;margin:unset}.box-lt-treeview .list-root li:nth-child(odd){background-color:#a9a9a9}.box-lt-treeview .list-root li{text-transform:capitalize;padding:15px;cursor:pointer}.box-lt-treeview .list-root li:hover{background-color:#f9cd0e}.list-item{background-color:#9c9c9c;border:1px solid;width:250px;z-index:1000;position:absolute;top:52px;left:130px;color:#fff}.list-item ul{list-style:none;padding:unset}.list-item li:nth-child(odd){background-color:#a9a9a9}.list-item li{text-transform:capitalize;cursor:pointer}.list-item li:hover{background-color:#f9cd0e}.treeview{list-style:none}.coll{padding:10px;cursor:pointer}.list-tree{list-style:none;margin-top:8px}.treeview li{padding:15px;position:relative}.plus{padding:7px 15px;border:unset;background-color:orange;color:#fff;cursor:pointer;margin-left:10px}.erase{padding:7px 15px;border:unset;background-color:#da3522;color:#fff;cursor:pointer;margin-left:10px}.treeview a{text-decoration:none;padding:10px 15px;color:#000;text-transform:capitalize}.control{display:inline-block;padding:5px;background-color:#e9e9e9}"]
            },] },
];
...
LtTreeviewInternalComponent.decorators = [
    { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"], args: [{
                ...
                template: "<ul class=\"list-tree\">\n  <li *ngFor=\"let item of data\">\n      <div class=\"list-item\" *ngIf=\"item.adding === true\">\n          <ul>\n              <li *ngFor=\"let n of listToAdd\"(click)=\"addNode(n)\"><span>{{n.label}}</span></li>\n          </ul>\n      </div>\n      <span class=\"coll\" (click)=\"expand(item)\" *ngIf=\"item.expand === false; else expanse\">\n        <i class=\"fa fa-caret-right\"></i>\n      </span>\n      <ng-template #expanse>\n          <span class=\"coll\" (click)=\"expand(item)\">\n              <i class=\"fa fa-caret-down\"></i>\n          </span>\n      </ng-template>\n      <div class=\"control\">\n          <a>\n              {{item.label}}\n          </a>\n          <button class=\"plus\" (click)=\"add(item)\">\n              <i class=\"fa fa-plus\"></i>\n          </button>\n          <button class=\"erase\" (click)=\"delete(item)\">\n              <i class=\"fa fa-remove\"></i>\n          </button>\n      </div>\n      <lt-treeview-internal [data] = \"item.children\" [parent]=\"item\" [listToAdd]=\"listToAdd\" [show]=\"show\" [component]=\"component\" [callBackOnDelete]=\"callBackOnDelete\" [callBackOnUpdate]=\"callBackOnUpdate\" *ngIf=\"item.expand === true\"></lt-treeview-internal>\n    </li>\n</ul>",
                styles: [".coll{padding:10px;cursor:pointer}.list-tree{list-style:none;margin-top:8px}.list-tree li{padding:15px}.plus{padding:7px 15px;border:unset;background-color:orange;color:#fff;cursor:pointer;margin-left:10px}.erase{padding:7px 15px;border:unset;background-color:#da3522;color:#fff;cursor:pointer;margin-left:10px}.list-tree a{text-decoration:none;padding:10px 15px;color:#000;text-transform:capitalize}.control{display:inline-block;padding:5px;background-color:#e9e9e9}.list-item{background-color:#9c9c9c;border:1px solid;width:250px;z-index:1000;position:absolute;top:52px;left:130px;color:#fff}.list-item ul{list-style:none;padding:unset}.list-item li:nth-child(odd){background-color:#a9a9a9}.list-item li{text-transform:capitalize;cursor:pointer}.list-item li:hover{background-color:#f9cd0e}"]
            },] },
];
...
//# sourceMappingURL=lt-treeview.js.map
...
var ComponentComponent = (function () {
    ...
    ComponentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [website_service_1.WebsiteService, router_1.ActivatedRoute, router_1.Router])
    ], ComponentComponent);
...
var ComponentsComponent = (function (_super) {
    ...
    ComponentsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [website_service_1.WebsiteService, router_1.Router])
    ], ComponentsComponent);
...
var PageComponent = (function () {
    ...
    PageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [website_service_1.WebsiteService, router_1.ActivatedRoute, router_1.Router, ng_bootstrap_1.NgbModal])
    ], PageComponent);
