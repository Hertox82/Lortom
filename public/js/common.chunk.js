...
var FilesServices = (function (_super) {
     ...
     */
    FilesServices.prototype.getFilesFrom = function (params) {
        var _this = this;
    ...
    FilesServices.prototype.convertLortomFileToLtFile = function (file) {
        return {
            img: file.file.img,
            name: file.file.name,
            id: file.file.id
     ...
     * @param file
     */
    FilesServices.prototype.saveFile = function (file, idObject, nameObject) {
        var _this = this;
